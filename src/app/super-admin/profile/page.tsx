...
import { z } from 'zod';
import { LogOut, Lock, ChevronRight, Moon, Sun } from 'lucide-react';
    ...
    <div>
      ...
      <div className="p-4 md:p-6 space-y-5 max-w-5xl">
        ...
        <div className="flex flex-col items-center py-6">
          ...
          <span className="mt-2 px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 text-xs font-medium">
            Super Admin
          </span>
        </div>
        ...
        <Card>
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between py-1">
              ...
              <span className="font-medium text-amber-600 dark:text-amber-400">Quản trị hệ thống</span>
            </div>
          </div>
        </Card>
